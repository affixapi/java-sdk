...
public class ManagementApiTest {
    ...
    public void clientTest() throws ApiException {
        ClientResponse response = api.client();
    ...
    public void disconnectTest() throws ApiException {
        DisconnectResponse response = api.disconnect();
    ...
    public void introspectTest() throws ApiException {
        IntrospectResponse response = api.introspect();
    ...
    public void tokensTest() throws ApiException {
        List<Object> response = api.tokens();
    ...
    public void updateClientTest() throws ApiException {
        ...
        ClientResponse response = api.updateClient(clientRequest);
