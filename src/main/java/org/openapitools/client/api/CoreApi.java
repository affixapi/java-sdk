...
public class CoreApi {
     ...
     */
    public okhttp3.Call providersCall(final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call providersValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = providersCall(_callback);
        return localVarCall;
     ...
     */
    public List<Object> providers() throws ApiException {
        ApiResponse<List<Object>> localVarResp = providersWithHttpInfo();
     ...
     */
    public ApiResponse<List<Object>> providersWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = providersValidateBeforeCall(null);
     ...
     */
    public okhttp3.Call providersAsync(final ApiCallback<List<Object>> _callback) throws ApiException {

        okhttp3.Call localVarCall = providersValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<List<Object>>(){}.getType();
