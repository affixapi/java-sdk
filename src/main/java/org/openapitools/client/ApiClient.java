...
public class ApiClient {
    ...
    private String basePath = "https://api.affixapi.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2023-03-01/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.affixapi.com
