...
/**
 * Gets or Sets employment-statusResponse
 */
@JsonAdapter(EmploymentStatusResponse.Adapter.class)
public enum EmploymentStatusResponse {
  ...
  EmploymentStatusResponse(String value) {
    this.value = value;
  }
  ...
  public static EmploymentStatusResponse fromValue(String value) {
    for (EmploymentStatusResponse b : EmploymentStatusResponse.values()) {
  ...
  public static class Adapter extends TypeAdapter<EmploymentStatusResponse> {
    @Override
    public void write(final JsonWriter jsonWriter, final EmploymentStatusResponse enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public EmploymentStatusResponse read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return EmploymentStatusResponse.fromValue(value);
    }
  }
}
