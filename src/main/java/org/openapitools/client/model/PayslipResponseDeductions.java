...
public class PayslipResponseDeductions {
  ...
  public PayslipResponseDeductions name(String name) {
   ...
   * @return name
  **/
  @ApiModelProperty(example = "Private Insurance Premium (Employee)", required = true, value = "")
  ...
  public PayslipResponseDeductions amount(BigDecimal amount) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PayslipResponseDeductions payslipResponseDeductions = (PayslipResponseDeductions) o;
    return Objects.equals(this.name, payslipResponseDeductions.name) &&
        Objects.equals(this.amount, payslipResponseDeductions.amount);
  }
