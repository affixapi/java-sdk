...
public class InlineResponse401 {
  ...
  public InlineResponse401 error(ErrorEnum error) {
  ...
  **/
   ...
   * @return message
  **/
  @ApiModelProperty(example = "Your password is incorrect", required = true, value = "A descriptive description of the error ")
