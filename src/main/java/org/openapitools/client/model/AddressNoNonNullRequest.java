 ...
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2025-07-10T12:09:35.409085321Z[Etc/UTC]")
public class AddressNoNonNullRequest {
  ...
  public static final String SERIALIZED_NAME_ADMINISTRATIVE_AREA = "administrative_area";
  ...
  public AddressNoNonNullRequest streetAddress(String streetAddress) {
  ...
  **/
  ...
  @ApiModelProperty(example = "221 S Main Street", required = true, value = "")
  ...
  public AddressNoNonNullRequest locality(String locality) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Yuma", required = true, value = "")
  ...
  public AddressNoNonNullRequest administrativeArea(String administrativeArea) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "AZ", required = true, value = "The administrative area of the address. If US or CA, the two-letter state or province abbreviation. Else, the province / administrative area; such as, `Dublin 2` or `County Cork` ")
  ...
  public AddressNoNonNullRequest country(CountryEnum country) {
  ...
  **/
  ...
  public AddressNoNonNullRequest postCode(String postCode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "30691", required = true, value = "")
  ...
  public boolean equals(Object o) {
    ...
    AddressNoNonNullRequest addressNoNonNullRequest = (AddressNoNonNullRequest) o;
    return Objects.equals(this.streetAddress, addressNoNonNullRequest.streetAddress) &&
        Objects.equals(this.locality, addressNoNonNullRequest.locality) &&
        Objects.equals(this.administrativeArea, addressNoNonNullRequest.administrativeArea) &&
        Objects.equals(this.country, addressNoNonNullRequest.country) &&
        Objects.equals(this.postCode, addressNoNonNullRequest.postCode);
  }

  @Override
  public int hashCode() {
    return Objects.hash(streetAddress, locality, administrativeArea, country, postCode);
  }
