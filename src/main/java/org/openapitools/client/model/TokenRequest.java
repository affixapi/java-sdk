...
public class TokenRequest {
   ...
   * @return clientId
  **/
  @ApiModelProperty(example = "00000000-00000000-00000000-00000000", required = true, value = "The client ID you received when you first created the application")
   ...
   * @return clientSecret
  **/
  @ApiModelProperty(example = "ffffffff-ffffffff-ffffffff-ffffffff", required = true, value = "The client secret. Since there can be multiple `client_secret`s (to allow for rotation of secrets without downtime to your customers), any current `client_secret` is valid  Please email me after signup and I will set both your client secret and redirect_uri (required) when you reach out. ")
   ...
   * @return grantType
  **/
  @ApiModelProperty(example = "authorization_code", required = true, value = "This is a hardcoded value required by the OAuth 2.1 spec")
   ...
   * @return code
  **/
  @ApiModelProperty(example = "Y2xpZW50IzkzMTU4MGQwLWYwYjctNGJiOC1iYmZmLWI4MTNlYzMxNTVjYXxjb2RlIzE1MmIwYjk3LTg2ZWMtNDZlNC1hZDUyLWY5ZTAxNzE2MDIwNAo=", required = true, value = "This is the code you received in the query string")
   ...
   * @return redirectUri
  **/
  @ApiModelProperty(example = "https://example.com", required = true, value = "Indicates the URI to return the user to after authorization is complete, which is the endpoint on your server to receive the authorization_code.  Must be identical to the redirect URI provided in the original link.  Please email me after signup and I will set both your client secret and redirect_uri (required) when you reach out. ")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(clientId, clientSecret, grantType, code, redirectUri);
  }
