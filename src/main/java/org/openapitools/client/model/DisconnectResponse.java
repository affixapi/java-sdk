...
public class DisconnectResponse {
   ...
   */
  @JsonAdapter(DisconnectedEnum.Adapter.class)
  public enum DisconnectedEnum {
TRUE(true);

    private Boolean value;

    DisconnectedEnum(Boolean value) {
      this.value = value;
    }
    ...
    public static DisconnectedEnum fromValue(Boolean value) {
      for (DisconnectedEnum b : DisconnectedEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<DisconnectedEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final DisconnectedEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public DisconnectedEnum read(final JsonReader jsonReader) throws IOException {
        Boolean value =  jsonReader.nextBoolean();
        return DisconnectedEnum.fromValue(value);
      }
    }
  }
  ...
  private DisconnectedEnum disconnected;
   ...
   * @return disconnected
  **/
  @ApiModelProperty(example = "true", required = true, value = "The access token has been disconnected and is no longer allowed to be used by your application")

  public DisconnectedEnum getDisconnected() {
    return disconnected;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.disconnected, disconnectResponse.disconnected);
  }
