...
/**
 * Gets or Sets payrun-typeResponse
 */
@JsonAdapter(PayrunTypeResponse.Adapter.class)
public enum PayrunTypeResponse {
  ...
  PayrunTypeResponse(String value) {
    this.value = value;
  }
  ...
  public static PayrunTypeResponse fromValue(String value) {
    for (PayrunTypeResponse b : PayrunTypeResponse.values()) {
  ...
  public static class Adapter extends TypeAdapter<PayrunTypeResponse> {
    @Override
    public void write(final JsonWriter jsonWriter, final PayrunTypeResponse enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PayrunTypeResponse read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PayrunTypeResponse.fromValue(value);
    }
  }
}
