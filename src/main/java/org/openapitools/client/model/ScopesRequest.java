...
/**
 * Gets or Sets ScopesRequest
 */
@JsonAdapter(ScopesRequest.Adapter.class)
public enum ScopesRequest {
  ...
  public static ScopesRequest fromValue(String value) {
    for (ScopesRequest b : ScopesRequest.values()) {
  ...
  public static class Adapter extends TypeAdapter<ScopesRequest> {
    @Override
    public void write(final JsonWriter jsonWriter, final ScopesRequest enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ScopesRequest read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ScopesRequest.fromValue(value);
    }
  }
}
