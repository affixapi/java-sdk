...
public class InlineResponse409 {
  ...
  public InlineResponse409 code(String code) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The authorization code insert that caused a conflict ")
  ...
  public InlineResponse409 token(String token) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The access token insert that caused a conflict ")
  ...
  public InlineResponse409 error(ErrorEnum error) {
   ...
   * @return error
  **/
  @ApiModelProperty(required = true, value = "The description of the type of error, ie conflict of two requests of the the same authorization code ")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, inlineResponse409.code) &&
        Objects.equals(this.token, inlineResponse409.token) &&
        Objects.equals(this.error, inlineResponse409.error);
  }

  @Override
  public int hashCode() {
    return Objects.hash(code, token, error);
  }
