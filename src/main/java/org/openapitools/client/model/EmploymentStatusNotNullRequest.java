...
/**
 * Gets or Sets employment-status-not-nullRequest
 */
@JsonAdapter(EmploymentStatusNotNullRequest.Adapter.class)
public enum EmploymentStatusNotNullRequest {
  ...
  EmploymentStatusNotNullRequest(String value) {
    this.value = value;
  }
  ...
  public static EmploymentStatusNotNullRequest fromValue(String value) {
    for (EmploymentStatusNotNullRequest b : EmploymentStatusNotNullRequest.values()) {
  ...
  public static class Adapter extends TypeAdapter<EmploymentStatusNotNullRequest> {
    @Override
    public void write(final JsonWriter jsonWriter, final EmploymentStatusNotNullRequest enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public EmploymentStatusNotNullRequest read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return EmploymentStatusNotNullRequest.fromValue(value);
    }
  }
}
