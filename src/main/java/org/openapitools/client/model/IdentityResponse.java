...
public class IdentityResponse {
   ...
   * @return name
  **/
  @ApiModelProperty(example = "Laurine Barton", required = true, value = "The name of the individual for the respective account, if known")
  ...
  public IdentityResponse email(String email) {
   ...
   * @return email
  **/
  @ApiModelProperty(example = "laurine.barton@me.com", required = true, value = "The email of the individual for the respective account, if known")
  ...
  public IdentityResponse phoneNumber(String phoneNumber) {
  ...
  **/
  ...
  @ApiModelProperty(example = "14150000000", required = true, value = "The phone number of the individual for the respective account, if known. Nullable for tokens created prior to 2023-03-05 ")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, identityResponse.name) &&
        Objects.equals(this.email, identityResponse.email) &&
        Objects.equals(this.phoneNumber, identityResponse.phoneNumber);
  }
