...
/**
 * Gets or Sets ProviderResponse
 */
@JsonAdapter(ProviderResponse.Adapter.class)
public enum ProviderResponse {
  ...
  PAROLLA_IE("parolla.ie"),
  
  PAYFIT("payfit"),
  
  PERSONIO_DE("personio.de"),
  ...
  public static ProviderResponse fromValue(String value) {
    for (ProviderResponse b : ProviderResponse.values()) {
  ...
  public static class Adapter extends TypeAdapter<ProviderResponse> {
    @Override
    public void write(final JsonWriter jsonWriter, final ProviderResponse enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ProviderResponse read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ProviderResponse.fromValue(value);
    }
  }
}
