...
/**
 * Gets or Sets ModeResponse
 */
@JsonAdapter(ModeResponse.Adapter.class)
public enum ModeResponse {
  ...
  public static ModeResponse fromValue(String value) {
    for (ModeResponse b : ModeResponse.values()) {
  ...
  public static class Adapter extends TypeAdapter<ModeResponse> {
    @Override
    public void write(final JsonWriter jsonWriter, final ModeResponse enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ModeResponse read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ModeResponse.fromValue(value);
    }
  }
}
