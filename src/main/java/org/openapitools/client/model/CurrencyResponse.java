...
public enum CurrencyResponse {
  ...
  public static CurrencyResponse fromValue(String value) {
    for (CurrencyResponse b : CurrencyResponse.values()) {
  ...
  public static class Adapter extends TypeAdapter<CurrencyResponse> {
    @Override
    public void write(final JsonWriter jsonWriter, final CurrencyResponse enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CurrencyResponse read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CurrencyResponse.fromValue(value);
    }
  }
}
