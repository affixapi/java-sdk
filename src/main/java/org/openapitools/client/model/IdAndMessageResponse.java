...
public class IdAndMessageResponse {
  ...
  public IdAndMessageResponse message(String message) {
  ...
  **/
  ...
  public IdAndMessageResponse id(String id) {
   ...
   * @return id
  **/
  @ApiModelProperty(required = true, value = "The id of the entity that the id applies. For example, the transaction id")
  ...
  public boolean equals(Object o) {
    ...
    IdAndMessageResponse idAndMessageResponse = (IdAndMessageResponse) o;
    return Objects.equals(this.message, idAndMessageResponse.message) &&
        Objects.equals(this.id, idAndMessageResponse.id);
  }
