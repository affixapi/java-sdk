...
public class LocationNoNonNullRequest {
  ...
  private AddressNoNonNullRequest address;


  public LocationNoNonNullRequest id(String id) {
  ...
  **/
  ...
  public LocationNoNonNullRequest remoteId(String remoteId) {
  ...
  **/
  ...
  public LocationNoNonNullRequest name(String name) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "NYC Office", required = true, value = "System assigned description of the location")
  ...
  public LocationNoNonNullRequest type(String type) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "office", required = true, value = "The location's type. In cases where there is no clear mapping, the original value passed through will be returned. ")
  ...
  public LocationNoNonNullRequest address(AddressNoNonNullRequest address) {
  ...
  **/
  ...
  public AddressNoNonNullRequest getAddress() {
    return address;
  }


  public void setAddress(AddressNoNonNullRequest address) {
    this.address = address;
  }
  ...
  public boolean equals(Object o) {
    ...
    LocationNoNonNullRequest locationNoNonNullRequest = (LocationNoNonNullRequest) o;
    return Objects.equals(this.id, locationNoNonNullRequest.id) &&
        Objects.equals(this.remoteId, locationNoNonNullRequest.remoteId) &&
        Objects.equals(this.name, locationNoNonNullRequest.name) &&
        Objects.equals(this.type, locationNoNonNullRequest.type) &&
        Objects.equals(this.address, locationNoNonNullRequest.address);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, remoteId, name, type, address);
  }
