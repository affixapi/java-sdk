...
public class PayslipResponseTaxes {
  ...
  public PayslipResponseTaxes name(String name) {
   ...
   * @return name
  **/
  @ApiModelProperty(example = "Income Tax", required = true, value = "")
  ...
  public PayslipResponseTaxes amount(BigDecimal amount) {
   ...
   * @return amount
  **/
  @ApiModelProperty(example = "10025", required = true, value = "if USD/EUR/GBP, in cent")
  ...
  public PayslipResponseTaxes employerTax(Boolean employerTax) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PayslipResponseTaxes payslipResponseTaxes = (PayslipResponseTaxes) o;
    return Objects.equals(this.name, payslipResponseTaxes.name) &&
        Objects.equals(this.amount, payslipResponseTaxes.amount) &&
        Objects.equals(this.employerTax, payslipResponseTaxes.employerTax);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, amount, employerTax);
  }
