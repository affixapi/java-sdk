...
/**
 * Gets or Sets ProviderRequest
 */
@JsonAdapter(ProviderRequest.Adapter.class)
public enum ProviderRequest {
  ...
  public static ProviderRequest fromValue(String value) {
    for (ProviderRequest b : ProviderRequest.values()) {
  ...
  public static class Adapter extends TypeAdapter<ProviderRequest> {
    @Override
    public void write(final JsonWriter jsonWriter, final ProviderRequest enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ProviderRequest read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ProviderRequest.fromValue(value);
    }
  }
}
