 ...
 */
@JsonAdapter(ModeRequest.Adapter.class)
public enum ModeRequest {
  ...
  public static ModeRequest fromValue(String value) {
    for (ModeRequest b : ModeRequest.values()) {
  ...
  public static class Adapter extends TypeAdapter<ModeRequest> {
    @Override
    public void write(final JsonWriter jsonWriter, final ModeRequest enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ModeRequest read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ModeRequest.fromValue(value);
    }
  }
}
