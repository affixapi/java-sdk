...
public class PayslipResponseContributions {
  ...
  public PayslipResponseContributions name(String name) {
   ...
   * @return name
  **/
  @ApiModelProperty(example = "Private Health Insurance (Employer)", required = true, value = "")
  ...
  public PayslipResponseContributions amount(BigDecimal amount) {
   ...
   * @return amount
  **/
  @ApiModelProperty(example = "3454", required = true, value = "if USD/EUR/GBP, in cent")
  ...
  public boolean equals(Object o) {
    ...
    PayslipResponseContributions payslipResponseContributions = (PayslipResponseContributions) o;
    return Objects.equals(this.name, payslipResponseContributions.name) &&
        Objects.equals(this.amount, payslipResponseContributions.amount);
  }
