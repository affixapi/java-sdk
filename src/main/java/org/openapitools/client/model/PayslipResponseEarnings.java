...
public class PayslipResponseEarnings {
  ...
  public PayslipResponseEarnings name(String name) {
  ...
  **/
  ...
  public PayslipResponseEarnings amount(BigDecimal amount) {
   ...
   * @return amount
  **/
  @ApiModelProperty(example = "834234", required = true, value = "if USD/EUR/GBP, in cent")
  ...
  public PayslipResponseEarnings hours(BigDecimal hours) {
  ...
  **/
  ...
  @ApiModelProperty(example = "80", required = true, value = "hours, if applicable")
  ...
  public boolean equals(Object o) {
    ...
    PayslipResponseEarnings payslipResponseEarnings = (PayslipResponseEarnings) o;
    return Objects.equals(this.name, payslipResponseEarnings.name) &&
        Objects.equals(this.amount, payslipResponseEarnings.amount) &&
        Objects.equals(this.hours, payslipResponseEarnings.hours);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, amount, hours);
  }
