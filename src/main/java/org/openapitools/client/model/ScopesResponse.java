...
/**
 * Gets or Sets ScopesResponse
 */
@JsonAdapter(ScopesResponse.Adapter.class)
public enum ScopesResponse {
  
  OFFICIAL_COMPANY("/2023-03-01/official/company"),
  
  OFFICIAL_EMPLOYEE("/2023-03-01/official/employee"),
  
  OFFICIAL_EMPLOYEES("/2023-03-01/official/employees"),
  
  OFFICIAL_GROUPS("/2023-03-01/official/groups"),
  
  OFFICIAL_IDENTITY("/2023-03-01/official/identity"),
  
  OFFICIAL_TIME_OFF_BALANCES("/2023-03-01/official/time-off-balances"),
  
  OFFICIAL_TIME_OFF_ENTRIES("/2023-03-01/official/time-off-entries"),
  
  OFFICIAL_TIMESHEETS("/2023-03-01/official/timesheets"),
  
  OFFICIAL_WORK_LOCATIONS("/2023-03-01/official/work-locations"),
  
  DEVELOPER_COMPANY("/2023-03-01/developer/company"),
  
  DEVELOPER_EMPLOYEE("/2023-03-01/developer/employee"),
  
  DEVELOPER_EMPLOYEES("/2023-03-01/developer/employees"),
  
  DEVELOPER_GROUPS("/2023-03-01/developer/groups"),
  
  DEVELOPER_IDENTITY("/2023-03-01/developer/identity"),
  
  DEVELOPER_PAYRUNS("/2023-03-01/developer/payruns"),
  
  DEVELOPER_PAYRUNS_PAYRUN_ID("/2023-03-01/developer/payruns/:payrun_id"),
  
  DEVELOPER_TIME_OFF_BALANCES("/2023-03-01/developer/time-off-balances"),
  
  DEVELOPER_TIME_OFF_ENTRIES("/2023-03-01/developer/time-off-entries"),
  
  DEVELOPER_TIMESHEETS("/2023-03-01/developer/timesheets"),
  
  DEVELOPER_WORK_LOCATIONS("/2023-03-01/developer/work-locations");

  private String value;

  ScopesResponse(String value) {
    this.value = value;
  }
  ...
  public static ScopesResponse fromValue(String value) {
    for (ScopesResponse b : ScopesResponse.values()) {
  ...
  public static class Adapter extends TypeAdapter<ScopesResponse> {
    @Override
    public void write(final JsonWriter jsonWriter, final ScopesResponse enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ScopesResponse read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ScopesResponse.fromValue(value);
    }
  }
}
