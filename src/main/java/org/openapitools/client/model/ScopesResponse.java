...
public enum ScopesResponse {
  ...
  XHR_COMPANY("/2023-03-01/xhr/company"),
  
  XHR_EMPLOYEE("/2023-03-01/xhr/employee"),
  
  XHR_EMPLOYEES("/2023-03-01/xhr/employees"),
  
  XHR_GROUPS("/2023-03-01/xhr/groups"),
  
  XHR_IDENTITY("/2023-03-01/xhr/identity"),
  
  XHR_PAYRUNS("/2023-03-01/xhr/payruns"),
  
  XHR_PAYRUNS_PAYRUN_ID("/2023-03-01/xhr/payruns/:payrun_id"),
  
  XHR_TIME_OFF_BALANCES("/2023-03-01/xhr/time-off-balances"),
  
  XHR_TIME_OFF_ENTRIES("/2023-03-01/xhr/time-off-entries"),
  
  XHR_TIMESHEETS("/2023-03-01/xhr/timesheets"),
  
  XHR_WORK_LOCATIONS("/2023-03-01/xhr/work-locations");
